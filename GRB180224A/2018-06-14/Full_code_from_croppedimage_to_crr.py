...
if False:    #if condition written to run the cropped image part only once, (no need to repeat this part of the program for processing different filter for same input)(give if false if you don't want this part of the program to run again)
        basedir = r'C:\\Users\\Ria\\VB shared files\\archiveunziped\\raw_processed_data_folder\\GRB180224A\\2018-06-14\\'
        ...
        ipPath = basedir + 'science_archivezip'
...
medianbiasOp = convert2medianwithop(ipPath, comment_history,opPath,opFileName, biasFilter, shouldwritefile= False) #calling the function
